...
class _HomePageState extends State<HomePage> {
  ...
  loadData() async {
    await Future.delayed(Duration(seconds: 2)); // it'll take some time to fetch the data from json file so we will wait till 2 sec and put loading icon at that place
